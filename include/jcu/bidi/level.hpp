...
constexpr BidiLevel LEVEL_TYPE_DEFAULT_AUTO = 0xFC; // Lets the algorithm choose the default embedding
constexpr BidiLevel LEVEL_TYPE_LTR          = 0;
constexpr BidiLevel LEVEL_TYPE_RTL          = 1;
